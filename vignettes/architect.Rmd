...
1. The `theme` option can take value from `cayman`, `tactile`, `architect` and
`leonids`. The first three themes
are much inspired by and modified from various
[Github page themes](https://github.com/blog/1081-instantly-beautiful-project-pages),
and the last one is derived and modified from the
[Leonids](https://github.com/renyuanz/leonids) theme.
